...
class Uuid {
  ...
  late Function _globalRNG;
  late List<String> _byteToHex;
  late Map<String, int> _hexToByte;

  Uuid({Map<String, dynamic>? options}) {
    options = (options != null) ? options : {};
    _byteToHex = List<String>.filled(256, '');
  ...
  String v5(String? namespace, String? name, {Map<String, dynamic>? options}) {
    ...
    final hashBytes = crypto.sha1.convert(List.from(bytes)..addAll(nameBytes)).bytes;
